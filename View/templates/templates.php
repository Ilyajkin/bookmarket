...
<div class="container">
    <header class="row">
        ...
        <div class="col-md-4 contacts">
            <div class="row"><a href="mailto: vgbs@inbox.ru" class="email">books@inbox.ru</a></div>
    ...
    <main>
        ...
        <div class="row">
            <div class="row top-menu">
                <div class="col-md-4"><a href="../index.php" class="main">Главная страница</a></div>
    ...
    <footer class="row">
        <div class="col-md-6 lower-menu">
            <ul>
                <li><a href="../index.php" class="menu-item">Главная страница</a></li>
